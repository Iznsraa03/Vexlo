  ...
  return (
    ...
    >
      ...
      >
        {/* Circular Logo */}
        <div
          className="relative w-32 h-32 md:w-36 md:h-36 rounded-full overflow-hidden border-2 border-white/10 transition-all duration-300 group-hover:border-[#FF4D4D]/70 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(255,77,77,0.4)]"
          style={{
